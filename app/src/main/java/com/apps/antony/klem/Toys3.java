...
public class Toys3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_toys3);
        ...
        // Autoplay pergunta
        MediaPlayer opc = MediaPlayer.create(Toys3.this, R.raw.brinquedo_ball);
        opc.start();
    }
    ...
    {
        MediaPlayer opc = MediaPlayer.create(Toys3.this, R.raw.brinquedo_telefone);
        opc.start();
    ...
    {
        MediaPlayer opc = MediaPlayer.create(Toys3.this, R.raw.brinquedo_bola);
        opc.start();
    ...
    {
        MediaPlayer opc = MediaPlayer.create(Toys3.this, R.raw.brinquedo_aviao);
        opc.start();
    ...
    {
        MediaPlayer opc = MediaPlayer.create(Toys3.this, R.raw.brinquedo_boneca);
        opc.start();
    ...
    View.OnClickListener verificarResposta = new View.OnClickListener()
    {
        ...
        public void onClick (View v)
        {
            ...
            if (opcao == 2) {
                Intent intent = new Intent(Toys3.this, activity_correto.class);
            ...
            {
                Intent intent = new Intent(Toys3.this, activity_errado.class);
                intent.putExtra("tipo", "Brinquedo");
                intent.putExtra("posicao", 3);
                startActivity(intent);
                finish();
