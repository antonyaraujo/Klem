...
public class Fruits4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fruits4);
        ...
        // Autoplay pergunta
        MediaPlayer opc = MediaPlayer.create(Fruits4.this, R.raw.fruta_orange);
        opc.start();
    }
    ...
    {
        MediaPlayer opc = MediaPlayer.create(Fruits4.this, R.raw.fruta_morango);
        opc.start();
    ...
    {
        MediaPlayer opc = MediaPlayer.create(Fruits4.this, R.raw.fruta_laranja);
        opc.start();
    ...
    {
        MediaPlayer opc = MediaPlayer.create(Fruits4.this, R.raw.fruta_cereja);
        opc.start();
    ...
    {
        MediaPlayer opc = MediaPlayer.create(Fruits4.this, R.raw.fruta_pera);
        opc.start();
    ...
    View.OnClickListener verificarResposta = new View.OnClickListener()
    {
        ...
        public void onClick (View v)
        {
            ...
            if (opcao == 2) {
                Intent intent = new Intent(Fruits4.this, activity_correto.class);
            ...
            {
                Intent intent = new Intent(Fruits4.this, activity_errado.class);
                intent.putExtra("tipo", "Fruta");
                intent.putExtra("posicao", 4);
                startActivity(intent);
                finish();
