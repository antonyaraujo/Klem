...
public class Fruits1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Autoplay pergunta
        MediaPlayer opc = MediaPlayer.create(Fruits1.this, R.raw.fruta_maca);
        opc.start();
    }
    ...
    {
        MediaPlayer opc = MediaPlayer.create(Fruits1.this, R.raw.fruta_apple);
        opc.start();
    ...
    {
        MediaPlayer opc = MediaPlayer.create(Fruits1.this, R.raw.fruta_lemon);
        opc.start();
    ...
    {
        MediaPlayer opc = MediaPlayer.create(Fruits1.this, R.raw.fruta_cherry);
        opc.start();
    ...
    {
        MediaPlayer opc = MediaPlayer.create(Fruits1.this, R.raw.fruta_orange);
        opc.start();
    ...
    View.OnClickListener verificarResposta = new View.OnClickListener()
    {
        ...
        public void onClick (View v)
        {
            ...
            if (opcao == 1) {
                Intent intent = new Intent(Fruits1.this, activity_correto.class);
            ...
            {
                Intent intent = new Intent(Fruits1.this, activity_errado.class);
                intent.putExtra("tipo", "Fruta");
                intent.putExtra("posicao", 1);
                startActivity(intent);
                finish();
