...
public class Clothes3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_clothes3);

        // Invoca método que verifica resposta
        btResponder = findViewById(R.id.responderbt);
        btResponder.setOnClickListener(verificarResposta);

        // Autoplay pergunta
        MediaPlayer opc = MediaPlayer.create(Clothes3.this, R.raw.roupa_vestido);
        opc.start();
    }
    ...
    {
        MediaPlayer opc = MediaPlayer.create(Clothes3.this, R.raw.roupa_pants);
        opc.start();
    ...
    {
        MediaPlayer opc = MediaPlayer.create(Clothes3.this, R.raw.roupa_shirt);
        opc.start();
    ...
    {
        MediaPlayer opc = MediaPlayer.create(Clothes3.this, R.raw.roupa_dress);
        opc.start();
    ...
    {
        MediaPlayer opc = MediaPlayer.create(Clothes3.this, R.raw.roupa_hat);
        opc.start();
    ...
    View.OnClickListener verificarResposta = new View.OnClickListener()
    {
        ...
        public void onClick (View v)
        {
            ...
            if (opcao == 3) {
                Intent intent = new Intent(Clothes3.this, activity_correto.class);
            ...
            {
                Intent intent = new Intent(Clothes3.this, activity_errado.class);
                intent.putExtra("tipo", "Roupa");
                intent.putExtra("posicao", 3);
                startActivity(intent);
                finish();
