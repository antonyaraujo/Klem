...
public class Numbers5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Autoplay pergunta
        MediaPlayer opc = MediaPlayer.create(Numbers5.this, R.raw.numero_two);
        opc.start();
    }
    ...
    public void Opcao1(View v) {
        MediaPlayer opc = MediaPlayer.create(Numbers5.this, R.raw.numero_dez);
        opc.start();
    ...
    public void Opcao2(View v) {
        MediaPlayer opc = MediaPlayer.create(Numbers5.this, R.raw.numero_dois);
        opc.start();
    ...
    public void Opcao3(View v) {
        MediaPlayer opc = MediaPlayer.create(Numbers5.this, R.raw.numero_cinco);
        opc.start();
    ...
    public void Opcao4(View v) {
        MediaPlayer opc = MediaPlayer.create(Numbers5.this, R.raw.numero_sete);
        opc.start();
    ...
    View.OnClickListener verificarResposta = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            if (opcao == 2) {
                Intent intent = new Intent(Numbers5.this, activity_correto.class);
                intent.putExtra("tipo", "Numero");
                intent.putExtra("posicao", 5);
                startActivity(intent);
                finish();
            } else {
                Intent intent = new Intent(Numbers5.this, activity_errado.class);
                intent.putExtra("tipo", "Numero");
                intent.putExtra("posicao", 5);
                startActivity(intent);
                finish();
