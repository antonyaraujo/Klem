...
public class Fruits3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fruits3);


        // Invoca método para verificar resposta
        btResponder = findViewById(R.id.responderbt);
        btResponder.setOnClickListener(verificarResposta);

        // Autoplay pergunta
        MediaPlayer opc = MediaPlayer.create(Fruits3.this, R.raw.fruta_morango);
        opc.start();
    }
    ...
    {
        MediaPlayer opc = MediaPlayer.create(Fruits3.this, R.raw.fruta_strawberry);
        opc.start();
    ...
    {
        MediaPlayer opc = MediaPlayer.create(Fruits3.this, R.raw.fruta_cherry);
        opc.start();
    ...
    {
        MediaPlayer opc = MediaPlayer.create(Fruits3.this, R.raw.fruta_pear);
        opc.start();
    ...
    {
        MediaPlayer opc = MediaPlayer.create(Fruits3.this, R.raw.fruta_pineapple);
        opc.start();
    ...
    View.OnClickListener verificarResposta = new View.OnClickListener()
    {
        ...
        public void onClick (View v)
        {
            ...
            if (opcao == 1) {
                Intent intent = new Intent(Fruits3.this, activity_correto.class);
            ...
            {
                Intent intent = new Intent(Fruits3.this, activity_errado.class);
                intent.putExtra("tipo", "Fruta");
                intent.putExtra("posicao", 3);
                startActivity(intent);
                finish();
