...
public class Clothes5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_clothes5);
        ...
        // Autoplay pergunta
        MediaPlayer opc = MediaPlayer.create(Clothes5.this, R.raw.roupa_sapato);
        opc.start();
    ...
    {
        MediaPlayer opc = MediaPlayer.create(Clothes5.this, R.raw.roupa_shoe);
        opc.start();
    ...
    {
        MediaPlayer opc = MediaPlayer.create(Clothes5.this, R.raw.roupa_hat);
        opc.start();
    ...
    {
        MediaPlayer opc = MediaPlayer.create(Clothes5.this, R.raw.roupa_pants);
        opc.start();
    ...
    {
        MediaPlayer opc = MediaPlayer.create(Clothes5.this, R.raw.roupa_shirt);
        opc.start();
    ...
    View.OnClickListener verificarResposta = new View.OnClickListener()
    {
        ...
        public void onClick (View v)
        {
            ...
            if (opcao == 1) {
                Intent intent = new Intent(Clothes5.this, activity_correto.class);
            ...
            {
                Intent intent = new Intent(Clothes5.this, activity_errado.class);
                intent.putExtra("tipo", "Roupa");
                intent.putExtra("posicao", 5);
                startActivity(intent);
                finish();
