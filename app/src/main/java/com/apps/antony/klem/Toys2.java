...
public class Toys2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_toys2);
        ...
        // Autoplay pergunta
        MediaPlayer opc = MediaPlayer.create(Toys2.this, R.raw.brinquedo_boneca);
        opc.start();
    }
    ...
    {
        MediaPlayer opc = MediaPlayer.create(Toys2.this, R.raw.brinquedo_robot);
        opc.start();
    ...
    {
        MediaPlayer opc = MediaPlayer.create(Toys2.this, R.raw.brinquedo_car);
        opc.start();
    ...
    {
        MediaPlayer opc = MediaPlayer.create(Toys2.this, R.raw.brinquedo_doll);
        opc.start();
    ...
    {
        MediaPlayer opc = MediaPlayer.create(Toys2.this, R.raw.brinquedo_airplane);
        opc.start();
    ...
    View.OnClickListener verificarResposta = new View.OnClickListener()
    {
        ...
        public void onClick (View v)
        {
            ...
            if (opcao == 3) {
                Intent intent = new Intent(Toys2.this, activity_correto.class);
            ...
            {
                Intent intent = new Intent(Toys2.this, activity_errado.class);
                intent.putExtra("tipo", "Brinquedo");
                intent.putExtra("posicao", 2);
                startActivity(intent);
                finish();
