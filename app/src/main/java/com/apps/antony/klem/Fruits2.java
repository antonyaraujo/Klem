...
public class Fruits2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Autoplay pergunta
        MediaPlayer opc = MediaPlayer.create(Fruits2.this, R.raw.fruta_watermelon);
        opc.start();
    }
    ...
    {
        MediaPlayer opc = MediaPlayer.create(Fruits2.this, R.raw.fruta_abacaxi);
        opc.start();
    ...
    {
        MediaPlayer opc = MediaPlayer.create(Fruits2.this, R.raw.fruta_limao);
        opc.start();
    ...
    {
        MediaPlayer opc = MediaPlayer.create(Fruits2.this, R.raw.fruta_laranja);
        opc.start();
    ...
    {
        MediaPlayer opc = MediaPlayer.create(Fruits2.this, R.raw.fruta_melancia);
        opc.start();
    ...
    View.OnClickListener verificarResposta = new View.OnClickListener()
    {
        ...
        public void onClick (View v)
        {
            ...
            if (opcao == 4) {
                Intent intent = new Intent(Fruits2.this, activity_correto.class);
            ...
            {
                Intent intent = new Intent(Fruits2.this, activity_errado.class);
                intent.putExtra("tipo", "Fruta");
                intent.putExtra("posicao", 2);
                startActivity(intent);
                finish();
