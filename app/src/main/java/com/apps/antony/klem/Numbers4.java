...
public class Numbers4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Autoplay pergunta
        MediaPlayer opc = MediaPlayer.create(Numbers4.this, R.raw.numero_cinco);
        opc.start();
    ...
    public void Opcao1(View v) {
        MediaPlayer opc = MediaPlayer.create(Numbers4.this, R.raw.numero_five);
        opc.start();
    ...
    public void Opcao2(View v) {
        MediaPlayer opc = MediaPlayer.create(Numbers4.this, R.raw.numero_one);
        opc.start();
    ...
    public void Opcao3(View v) {
        MediaPlayer opc = MediaPlayer.create(Numbers4.this, R.raw.numero_seven);
        opc.start();
    ...
    public void Opcao4(View v) {
        MediaPlayer opc = MediaPlayer.create(Numbers4.this, R.raw.numero_four);
        opc.start();
    ...
    View.OnClickListener verificarResposta = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            if (opcao == 1) {
                Intent intent = new Intent(Numbers4.this, activity_correto.class);
                intent.putExtra("tipo", "Numero");
                intent.putExtra("posicao", 4);
                startActivity(intent);
                finish();
            } else {
                Intent intent = new Intent(Numbers4.this, activity_errado.class);
                intent.putExtra("tipo", "Numero");
                intent.putExtra("posicao", 4);
                startActivity(intent);
                finish();
