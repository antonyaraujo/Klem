...
public class Clothes2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Autoplay pergunta
        MediaPlayer pergunta = MediaPlayer.create(Clothes2.this, R.raw.roupa_pants);
        pergunta.start();
    ...
    {
        MediaPlayer opc = MediaPlayer.create(Clothes2.this, R.raw.roupa_camisa);
        opc.start();
    ...
    {
        MediaPlayer opc = MediaPlayer.create(Clothes2.this, R.raw.roupa_vestido);
        opc.start();
    ...
    {
        MediaPlayer opc = MediaPlayer.create(Clothes2.this, R.raw.roupa_sapato);
        opc.start();
    ...
    {
        MediaPlayer opc = MediaPlayer.create(Clothes2.this, R.raw.roupa_calca);
        opc.start();
    ...
    View.OnClickListener verificarResposta = new View.OnClickListener()
    {
        ...
        public void onClick (View v)
        {
            ...
            if (opcao == 4) {
                Intent intent = new Intent(Clothes2.this, activity_correto.class);
            ...
            {
                Intent intent = new Intent(Clothes2.this, activity_errado.class);
                intent.putExtra("tipo", "Roupa");
                intent.putExtra("posicao", 2);
                startActivity(intent);
                finish();
